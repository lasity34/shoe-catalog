...
function initializeApp() {
  ...
  const default_shoe = shoeInstance.get_default_shoe(shoe_data)

  const colorDropdown = document.querySelector("#color_select");
  const sizeDropdown = document.querySelector("#size_select");
  const brandDropdown = document.querySelector("#brand_select");

  colorDropdown.value = default_shoe.color;
  sizeDropdown.value = default_shoe.size;
  brandDropdown.value = default_shoe.brand;
