...
color_select.value.addEventListener("change", updateCategoryTemplate)
size_select.value.addEventListener("change", updateCategoryTemplate)
brand_select.value.addEventListener("change", updateCategoryTemplate)
