...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initializeApp() {
    ...
    function dropdownSelection(event) {
      console.log('event.target:', event.target); // let's see what event.target is

      const dropdownContent = event.target.parentElement;
      console.log('dropdownContent:', dropdownContent); // let's see what dropdownContent is
    
      const dropdownParent = dropdownContent.parentElement;
      console.log('dropdownParent:', dropdownParent); // let's see what dropdownParent is
