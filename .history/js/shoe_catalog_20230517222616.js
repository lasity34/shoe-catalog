...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function update_display() {
    const selected_color = document.querySelector("#color_dropdown .dropdown-button").innerHTML
    const selected_size = document.querySelector("#size_dropdown .dropdown-button").innerHTML
    ...
    console.log(typeof selected_color)
