...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function dropdownSelection(event) {
    ...
    console.log('Dropdown Button:', dropdownButton); // Debugging line
  
    const dropdownIndicator = dropdownButton.querySelector(".dropdown-indicator");
  
    console.log('Dropdown Indicator:', dropdownIndicator); // Debugging line
  
    dropdownButton.textContent = event.target.textContent;
    dropdownIndicator.textContent = "x";
  
    dropdownButton.appendChild(dropdownIndicator);ownButton.appendChild(dropdownIndicator); // This adds the indicator back to the button after setting the button text.
