...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function dropdownSelection(event) {
    ...
    const dropdownIndicator = dropdownButton.querySelector(".dropdown-indicator");
  
    dropdownButton.textContent = event.target.textContent; // This sets the button text to the selected value.
    
    dropdownIndicator.textContent = "x"; // This changes the indicator to 'x'.
    dropdownIndicator.addEventListener('click', indicatorClick);
    dropdownButton.appendChild(dropdownIndicator); // This adds the indicator back to the button after setting the button text.
  ...
  function resetButtonValues() {
    ...
    dropdownButtons.forEach((button) => {
      const dropdownIndicator = button.querySelector(".dropdown-indicator");
      dropdownIndicator.textContent = "*"; // Change the 'x' back to '*'.
      ...
      button.appendChild(dropdownIndicator); // Add the indicator back to the button after resetting the button text.
  ...
  function indicatorClick(event) {
    ...
    if (indicator.textContent === 'x') {
      // If the indicator is 'x', reset this button and change the indicator back to '*'.
      if (button.parentNode.id === "color_dropdown") {
        button.textContent = "Color";
      } else if (button.parentNode.id === "size_dropdown") {
        button.textContent = "Size";
      ...
      button.appendChild(indicator); // Add the indicator back to the button after resetting the button text.
